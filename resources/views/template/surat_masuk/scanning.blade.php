                ...
                <div class="row mb-2">
                  <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item active">Scanning Surat</li>
                    </ol>
                  </div>
                </div>
              </div><!-- /.container-fluid -->
            ...
            <section class="content">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Scanning Surat</h3>
                    ...
                    <div class="row" id="QR-Code">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <button title="Image shoot" class="btn btn-info btn-sm disabled" id="grab-img" type="button" data-toggle="tooltip"><span class="fa fa-picture"></span></button>
                  ...
                  var args = {
                      ...
                      cameraError: function(error) {
                          ...
                          if (error.name == "NotSupportedError") {
                              ...
                              if (ans) {
                                  window.open("http://aaptechmil.com");
                              }
                          } else {
                              for (p in error) {
                                  message += p + ": " + error[p] + "\n";
