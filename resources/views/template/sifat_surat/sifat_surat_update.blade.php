          ...
          <div class="content-wrapper">
            ...
            <section class="content">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{ url('sifat_surat/update/'.$data->id) }}" method="post" class="form-horizontal">
                  {{csrf_field()}}
                  <input type="hidden" name="_method" value="patch">
                  <div class="form-group">
                    <label class="col-md-2">Nama Sifat Surat</label>
                    <div class="col-md-10">
                      <input type="text" name="nama_sifat_surat" value="{{ $data->nama_sifat_surat }}" class="form-control">
                      <input type="hidden" name="nama_sifat_surat_old" value="{{ $data->nama_sifat_surat }}" class="form-control">
